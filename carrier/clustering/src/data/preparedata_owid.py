...
covid_data_dict = pd.read_csv("https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/owid-covid-codebook.csv")
...
# %%
covid_data_dict[['column', 'description']].style.set_properties(**{'text-align': 'left'}).hide_index()
# %%
